...
class SymbolPaperWallet {
     ...
     * @param font
     */
    private async writeMnemonicPage(pdfDoc: PDFDocument, page: PDFPage, font: PDFFont): Promise<void> {
     ...
     * @param pdfDoc
     */
    private async writeAccountPage(account: IAccountInfo, pdfDoc: PDFDocument, page: PDFPage, font: PDFFont): Promise<void> {
